...
import 'package:taxi_app/widgets/PredictionTile.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  void searchPlace(String placeName) async {
    ...
    if(placeName.length > 1){
      ...
      String url = 'https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapKey&sessiontoken=123254251&components=country:kz';
                ...
                children: <Widget>[
                  ...
                  Stack(
                    children: <Widget>[
                      ...
                      Center(
                        child: Text('Выбрать пункт назначения',
                          ...
                          child: Padding(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Выбрать место посадки',
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                  hintText: 'Выбрать место назначения',
                                  fillColor: BrandColors.colorLightGrayFair,
                                  filled: true,
                                  border: InputBorder.none,
                                  isDense: true,
          ...
          Padding(
            ...
            child: ListView.separated(
              padding: EdgeInsets.all(0),
                ...
                separatorBuilder: (BuildContext context, int index) => BrandDivier(),
