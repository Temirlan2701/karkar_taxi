...
class _MainpageState extends State<Mainpage> with TickerProviderStateMixin {
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              title: Text('Бесплатные поездки', style: kDrawerItemStyle,),
            ),

            ListTile(
              leading: Icon(OMIcons.creditCard),
              title: Text('Оплата', style: kDrawerItemStyle,),
            ),

            ListTile(
              leading: Icon(OMIcons.history),
              title: Text('История поездок', style: kDrawerItemStyle,),
            ),

            ListTile(
              leading: Icon(OMIcons.contactSupport),
              title: Text('Служба поддержки', style: kDrawerItemStyle,),
            ),
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        SizedBox(height: 5,),
                        Text('Рады вас видеть', style: TextStyle(fontSize: 10),),
                        Text('Куда поедем?', style: TextStyle(fontSize: 18, fontFamily: 'Brand-Bold'),),
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text((tripDirectionDetails != null) ? 'ТГ ${HelperMethods.estimateFares(tripDirectionDetails)}' : '', style: TextStyle(fontSize: 18, fontFamily: 'Brand-Bold'),),
                              ],
                            ),
                          ),
                        ),
  ...
  if(pickLatLng.latitude > destinationLatLng.latitude && pickLatLng.longitude > destinationLatLng.longitude) {
    ...
    Marker pickupMarker = Marker(
      ...
      infoWindow: InfoWindow(title: pickup.placeName, snippet: 'Мое местоположение'),
    );
    ...
    Marker destinationMarker = Marker(
      ...
      infoWindow: InfoWindow(title: destination.placeName, snippet: 'Место назначения'),
    );
